    ...
    <div className="min-h-screen bg-white text-[#0A0A0A] font-sans selection:bg-[#0A0A0A] selection:text-white antialiased overflow-x-hidden">
      ...
      <main className="relative z-10 px-12">
        ...
        >
          ...
          <motion.h1 variants={fadeInUp} className="text-[10vw] md:text-[7vw] font-medium tracking-[-0.05em] leading-[0.85] mb-12">
          ...
          <motion.p variants={fadeInUp} className="text-sm md:text-lg text-[#0A0A0A]/40 max-w-lg mb-16 font-light leading-relaxed">
            The world's first browser-native 3D generator. <br/> Zero latency. Total privacy. Infinite scale.
          </motion.p>
          
          <motion.div variants={fadeInUp} className="flex flex-col sm:flex-row items-center gap-12 sm:items-center">
             <Link href="/editor" className="w-full sm:w-auto text-center px-16 py-6 bg-[#0A0A0A] text-white text-[10px] font-bold uppercase tracking-[0.4em] hover:bg-white hover:text-black hover:ring-1 hover:ring-black transition-all">
               Commence Creation
             </Link>
             <div className="hidden sm:block w-px h-12 bg-black/[0.1]" />
             <div className="hidden sm:block text-[10px] font-bold uppercase tracking-[0.3em] text-black/20">
        ...
        {/* About Section */}
        <section id="about" className="mt-60 max-w-4xl py-20">
           <div className="text-[10px] font-bold uppercase tracking-[0.5em] text-[#0A0A0A]/30 mb-12">Our Philosophy</div>
           <h2 className="text-[5vw] font-medium tracking-[-0.04em] leading-[0.95] mb-16">
              Simplifying the <span className="opacity-30">complexities</span> of the third dimension.
           </h2>
           <div className="grid grid-cols-1 md:grid-cols-2 gap-20 text-sm text-black/40 font-light leading-relaxed">
              <p>
        ...
        <section id="lab" className="mt-60 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 border-t border-black/[0.08]">
        ...
        <section className="mt-40 border border-black/[0.08] p-1 shadow-sm">
           <div className="aspect-[21/9] bg-[#F9F9F9] relative overflow-hidden flex items-center justify-center group">
              <Plus className="absolute top-10 left-10 w-4 h-4 opacity-10 group-hover:opacity-100 transition-opacity" />
              <Plus className="absolute top-10 right-10 w-4 h-4 opacity-10 group-hover:opacity-100 transition-opacity" />
              <Plus className="absolute bottom-10 left-10 w-4 h-4 opacity-10 group-hover:opacity-100 transition-opacity" />
              <Plus className="absolute bottom-10 right-10 w-4 h-4 opacity-10 group-hover:opacity-100 transition-opacity" />
              ...
              <img 
                ...
                alt="Minimal Preview" 
                className="w-1/2 h-auto opacity-80 grayscale mix-blend-multiply group-hover:grayscale-0 group-hover:opacity-100 transition-all duration-1000"
              />
        ...
        <section id="dev" className="mt-60 pt-40 border-t border-black/[0.08]">
           ...
           <div className="flex flex-col lg:flex-row gap-24 items-start">
             <div className="flex-1 space-y-12">
               <h2 className="text-[7vw] font-medium tracking-tighter leading-[0.8]">Abir Hasan <br/> <span className="opacity-30">Siam.</span></h2>
               <div className="flex gap-12 text-[10px] font-bold uppercase tracking-[0.3em] text-black/40">
                  <span>22 Yrs</span>
             ...
             <div className="flex-1 space-y-12">
               <p className="text-xl md:text-2xl font-light text-black/60 leading-relaxed max-w-xl">
               ...
               <div className="flex flex-wrap gap-x-8 gap-y-4 text-[10px] font-bold uppercase tracking-[0.2em] text-black/30">
                  <span>React.js</span>
                  <span>Flutter</span>
                  <span>Python</span>
                  <span>Three.js</span>
        ...
        {/* Contact Section */}
        <section id="contact" className="mt-60 pt-40 border-t border-black/[0.08]">
           <div className="flex flex-col md:flex-row justify-between gap-24">
              <div className="max-w-md">
                 <div className="text-[10px] font-bold uppercase tracking-[0.5em] text-[#0A0A0A]/30 mb-8">Direct Access</div>
                 <h2 className="text-[5vw] font-medium tracking-tight mb-8">Reach out to <br/> our architects.</h2>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-20 self-end mb-20">
                 ...
                 <ContactItem title="Office" value="51.5074° N, 0.1278° W" />
              </div>
           </div>
        </section>

        {/* Extreme CTA */}
        <section className="mt-40 text-center py-40 border-y border-black/[0.08]">
           <h2 className="text-[5vw] font-medium tracking-[-0.04em] mb-12 opacity-80">Commence your legacy.</h2>
           <Link href="/editor" className="inline-block px-16 py-6 border border-black text-[10px] font-bold uppercase tracking-[0.5em] hover:bg-black hover:text-white transition-all">
             Open Studio
           </Link>
        </section>
      </main>
      ...
      {/* Minimal Footer */}
      <footer className="px-12 py-20 bg-white border-t border-black/[0.08]">
        <div className="flex flex-col md:flex-row justify-between items-start gap-20">
          <div className="space-y-4">
            <span className="text-[10px] font-bold uppercase tracking-[0.4em]">3D STUDIO</span>
            <p className="text-[9px] text-black/20 font-mono">51.5074° N, 0.1278° W</p>
          </div>
...
function SpecItem({ num, title, desc }: any) {
  return (
    <div className="p-12 border-r border-b border-black/[0.08] lg:border-b-0 group">
      <div className="text-[10px] font-mono text-black/20 mb-8">{num}</div>
      <h3 className="text-[10px] font-bold uppercase tracking-[0.3em] mb-6">{title}</h3>
